...
In https://github.com/DoudleStudios/WhiteHot, look for the fork icon in the top right. Click it to create a fork of the repository (repo).

Basically, this will copy the repo into your GitHub account url. It should create a copy at https://github.com/YOURUSERNAME/WhiteHot, where `YOURUSERNAME` is replaced with exactly that.
...
```bash
git clone --recursive https://github.com/YOURUSERNAME/WhiteHot.git
```

You should now have a new folder called `WhiteHot`. Verify this by going into the directory:
...
You should see `fetch` and `push` urls with links to your forked repo under your account (Ex: `https://github.com/YOURUSERNAME/WhiteHot.git`). You are all set to make working changes to the project on your local machine.
...
```bash
git remote add upstream https://github.com/DoudleStudios/WhiteHot.git
git fetch upstream
```

After adding the remote upstream, you should now see it if you run `git remote -v` again:
```bash
origin https://github.com/YOURUSERNAME/WhiteHot.git (fetch)
origin https://github.com/YOURUSERNAME/WhiteHot.git (push)
upstream https://github.com/DoudleStudios/WhiteHot.git (fetch)
upstream https://github.com/DousdleStudios/WhiteHot.git (push)
```
